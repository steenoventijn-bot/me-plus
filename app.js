...
const extra=['./parts/v7c-fix.txt','./parts/v8-fix.txt','./parts/v9-ui.txt','./parts/v9-media.txt','./parts/v10-social-1.txt','./parts/v10-social-2.txt','./parts/v10-runtime.txt','./parts/v11-account.txt','./parts/v11-avatar.txt','./parts/v11-social.txt','./parts/v11-runtime.txt','./parts/v12-world-core.txt','./parts/v12-world-ui.txt','./parts/v13-world-quality.txt','./parts/v13-avatar-quality.txt','./parts/v13-reader-quality.txt','./parts/v13-brand-quality.txt','./parts/v13-task-coins.txt','./parts/v13q4-critical-fixes.txt'];
